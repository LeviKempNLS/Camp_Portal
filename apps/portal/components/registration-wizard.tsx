...
const form: FormSchema = { id:"camp-registration", version:1, title:"Faith Adventures Camp registration", sections:[
 ...
 { id:"camper", title:"Camper information", fields:[{id:"camperName",type:"text",label:"Camper full name",required:true},{id:"birthDate",type:"date",label:"Date of birth",required:true},{id:"grade",type:"text",label:"Grade just completed",required:true},{id:"camperEmail",type:"text",label:"Camper email"},{id:"cabinMate",type:"text",label:"One mutual cabin-mate request",helpText:"Requests are considered but not guaranteed."}] },
 { id:"guardian", title:"Parent or guardian", fields:[{id:"guardianName",type:"text",label:"Parent/guardian full name",required:true},{id:"guardianEmail",type:"text",label:"Email address",required:true},{id:"guardianPhone",type:"text",label:"Best phone number",required:true},{id:"address",type:"textarea",label:"Home address",required:true},{id:"emergencyContact",type:"text",label:"Emergency contact name and phone",required:true},{id:"pickupRestrictions",type:"textarea",label:"Pickup restrictions",helpText:"List people who may not pick up your child, with the reason if applicable."}] },
 { id:"health", title:"Health and care", description:"Only authorized medical staff and designated leaders may access this section.", fields:[{id:"insurance",type:"text",label:"Medical insurance carrier and policy/group number",required:true,sensitive:true},{id:"allergies",type:"textarea",label:"Allergies and how to manage reactions",required:true,sensitive:true},{id:"dietary",type:"textarea",label:"Dietary needs or restrictions",sensitive:true},{id:"medications",type:"textarea",label:"Medications, dosage, and timing",sensitive:true},{id:"healthNotes",type:"textarea",label:"Anything else camp leaders should know",sensitive:true}] },
